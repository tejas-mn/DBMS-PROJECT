...
@equipments_blueprint.route('/<int:page_num>')
def equipment(page_num=1):
    ...
    return render_template('/adminstrap_theme/adminstrap_theme/equipments.html' , isequipments="active" , title = "Equipments" , equipments = EQUIPMENTS.query.all() , members = MEMBERS.query.all() , Data_Paginate=Data_Paginate , isact="active" , eqcount=count )
