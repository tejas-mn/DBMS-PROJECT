...
class TRAINERS(db.Model):
    ...
    T_MOB_NO = db.Column(db.Numeric(precision=10 , asdecimal = False) , unique = True , nullable = False)
    ...
    def __init__(self  ,  t_name , t_gender , t_joindate , t_email ,  t_mob_no , t_location):
...
class MEMBERS(db.Model):
    ...
    M_MOB_NO = db.Column(db.Numeric(precision=10 , asdecimal = False) , unique = True , nullable = False)
    ...
    def __init__(self , m_name , m_gender , m_dob , m_weight , m_height , m_email , m_mob_no, m_location , m_joindate , tr_id , pk_id ):
